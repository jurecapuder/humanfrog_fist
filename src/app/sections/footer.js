    ...
    <>
      <footer className="bg-logo-blue text-white grid grid-cols-4 gap-4 p-8" style={{ padding: "0 10%"}}>
        ...
        <div>
          ...
          <a href="https://www.linkedin.com/company/fist-d-o-o/" className="flex items-center gap-2 text-[#BFC4F3]">
          ...
          <a href="https://www.youtube.com/@Fist_doo" className="flex items-center gap-2 text-[#BFC4F3]">
